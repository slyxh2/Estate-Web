...
export default function Home(props) {
  ...
  return (
    <div>
      ...
      />
      <Flex flexWrap='wrap'>
        {props.propertiesForRent.map((property) => <Property property={property} key={property.id} />)}
      </Flex>
      <Banner
        purpose='BUY A HOME'
      ...
      />
      <Flex flexWrap='wrap'>
        {props.propertiesForSale.map((property) => <Property property={property} key={property.id} />)}
      </Flex>
    </div>
  )
}
